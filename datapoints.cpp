...
QList<VertexData> cbPoints::getVertices() const
{
    return vertices;
}

void cbPoints::setVertices(const QList<VertexData> &value)
{
    vertices = value;
}

QList<GLushort> cbPoints::getIndices() const
{
    return indices;
}

void cbPoints::setIndices(const QList<GLushort> &value)
{
    indices = value;
}
cbPoints::cbPoints()
